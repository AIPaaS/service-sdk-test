...
public class ListSubPathTest extends ConfigClient {
	...
	public void setUp() throws Exception {
		...
		configClient.add(path,"test list sub path function");
	}
	...
	public void listSubPathWithWathcer() throws ConfigException {
		configClient.listSubPath(path, new ConfigWatcher() {
			@Override
